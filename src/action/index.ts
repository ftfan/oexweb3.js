...
export async function issueAsset(actionInfo, gasInfo, payloadInfo, privateKey) {
  ...
  const payload =
    '0x' +
    encode([payloadInfo.assetName, payloadInfo.symbol, amount, payloadInfo.decimals, payloadInfo.founder, payloadInfo.owner, upperLimit, payloadInfo.contractAccountName, payloadInfo.desc]).toString(
      'hex'
    );
